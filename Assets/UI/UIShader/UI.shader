...
Shader "UI"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_3_0_g238 = ( 1.0 - uv_TexCoord70.x );
			float temp_output_3_0_g239 = ( 1.0 - ( 1.0 - uv_TexCoord70.y ) );
			float4 tex2DNode68 = tex2D( _Empty_LifeBar, uv_TexCoord70 );
			float temp_output_3_0_g237 = ( (0.06 + (_Life - 0.0) * (0.83 - 0.06) / (1.0 - 0.0)) - uv_TexCoord70.x );
			float temp_output_3_0_g235 = ( 0.425 - uv_TexCoord70.y );
			float temp_output_82_0 = saturate( ( temp_output_3_0_g235 / fwidth( temp_output_3_0_g235 ) ) );
			float4 tex2DNode69 = tex2D( _LifeBar, uv_TexCoord70 );
			float temp_output_83_0 = ( saturate( ( temp_output_3_0_g237 / fwidth( temp_output_3_0_g237 ) ) ) * ( 1.0 - temp_output_82_0 ) * tex2DNode69.a );
			float temp_output_3_0_g236 = ( (0.1 + (_Stamina - 0.0) * (0.63 - 0.1) / (1.0 - 0.0)) - uv_TexCoord70.x );
			float temp_output_85_0 = ( temp_output_82_0 * tex2DNode69.a * saturate( ( temp_output_3_0_g236 / fwidth( temp_output_3_0_g236 ) ) ) );
			float4 lerpResult99 = lerp( ( saturate( ( temp_output_3_0_g238 / fwidth( temp_output_3_0_g238 ) ) ) * saturate( ( temp_output_3_0_g239 / fwidth( temp_output_3_0_g239 ) ) ) * tex2DNode68 ) , ( ( _LifeColor * temp_output_83_0 ) + ( temp_output_85_0 * _StaminaColor ) ) , ( temp_output_83_0 + temp_output_85_0 ));
			...
			float temp_output_3_0_g229 = ( 1.0 - uv_TexCoord163.x );
			float temp_output_3_0_g230 = ( 1.0 - ( 1.0 - uv_TexCoord163.x ) );
			float temp_output_3_0_g224 = ( 1.0 - uv_TexCoord163.y );
			float temp_output_3_0_g222 = ( 1.0 - ( 1.0 - uv_TexCoord163.y ) );
			float temp_output_199_0 = ( saturate( ( temp_output_3_0_g229 / fwidth( temp_output_3_0_g229 ) ) ) * saturate( ( temp_output_3_0_g230 / fwidth( temp_output_3_0_g230 ) ) ) * saturate( ( temp_output_3_0_g224 / fwidth( temp_output_3_0_g224 ) ) ) * saturate( ( temp_output_3_0_g222 / fwidth( temp_output_3_0_g222 ) ) ) );
			...
			float temp_output_3_0_g214 = ( 1.0 - uv_TexCoord215.x );
			float temp_output_3_0_g218 = ( 1.0 - ( 1.0 - uv_TexCoord215.x ) );
			float temp_output_3_0_g228 = ( 1.0 - uv_TexCoord215.y );
			float temp_output_3_0_g223 = ( 1.0 - ( 1.0 - uv_TexCoord215.y ) );
			float temp_output_243_0 = ( saturate( ( temp_output_3_0_g214 / fwidth( temp_output_3_0_g214 ) ) ) * saturate( ( temp_output_3_0_g218 / fwidth( temp_output_3_0_g218 ) ) ) * saturate( ( temp_output_3_0_g228 / fwidth( temp_output_3_0_g228 ) ) ) * saturate( ( temp_output_3_0_g223 / fwidth( temp_output_3_0_g223 ) ) ) );
			...
			float temp_output_3_0_g217 = ( 1.0 - uv_TexCoord252.x );
			...
			float temp_output_259_0 = ( saturate( ( temp_output_3_0_g217 / fwidth( temp_output_3_0_g217 ) ) ) * saturate( ( temp_output_3_0_g220 / fwidth( temp_output_3_0_g220 ) ) ) * saturate( ( temp_output_3_0_g213 / fwidth( temp_output_3_0_g213 ) ) ) * saturate( ( temp_output_3_0_g211 / fwidth( temp_output_3_0_g211 ) ) ) );
			...
			float temp_output_3_0_g216 = ( 1.0 - uv_TexCoord282.x );
			float temp_output_3_0_g227 = ( 1.0 - ( 1.0 - uv_TexCoord282.x ) );
			float temp_output_3_0_g215 = ( 1.0 - uv_TexCoord282.y );
			float temp_output_3_0_g212 = ( 1.0 - ( 1.0 - uv_TexCoord282.y ) );
			float temp_output_289_0 = ( saturate( ( temp_output_3_0_g216 / fwidth( temp_output_3_0_g216 ) ) ) * saturate( ( temp_output_3_0_g227 / fwidth( temp_output_3_0_g227 ) ) ) * saturate( ( temp_output_3_0_g215 / fwidth( temp_output_3_0_g215 ) ) ) * saturate( ( temp_output_3_0_g212 / fwidth( temp_output_3_0_g212 ) ) ) );
			...
			float temp_output_3_0_g221 = ( 1.0 - ( 1.0 - uv_TexCoord294.x ) );
			float temp_output_3_0_g219 = ( 1.0 - uv_TexCoord294.y );
			float temp_output_3_0_g225 = ( 1.0 - ( 1.0 - uv_TexCoord294.y ) );
			float temp_output_301_0 = ( saturate( ( temp_output_3_0_g226 / fwidth( temp_output_3_0_g226 ) ) ) * saturate( ( temp_output_3_0_g221 / fwidth( temp_output_3_0_g221 ) ) ) * saturate( ( temp_output_3_0_g219 / fwidth( temp_output_3_0_g219 ) ) ) * saturate( ( temp_output_3_0_g225 / fwidth( temp_output_3_0_g225 ) ) ) );
			...
			float temp_output_3_0_g232 = ( 1.0 - uv_TexCoord106.x );
			float temp_output_132_0 = saturate( ( temp_output_3_0_g232 / fwidth( temp_output_3_0_g232 ) ) );
			float temp_output_3_0_g234 = ( 1.0 - uv_TexCoord106.y );
			float temp_output_133_0 = saturate( ( temp_output_3_0_g234 / fwidth( temp_output_3_0_g234 ) ) );
			...
			float temp_output_3_0_g231 = ( 1.0 - ( 1.0 - uv_TexCoord112.x ) );
			float temp_output_137_0 = saturate( ( temp_output_3_0_g231 / fwidth( temp_output_3_0_g231 ) ) );
			float temp_output_3_0_g233 = ( 1.0 - uv_TexCoord112.y );
			float temp_output_138_0 = saturate( ( temp_output_3_0_g233 / fwidth( temp_output_3_0_g233 ) ) );
...
/*ASEBEGIN
Version=19001
1920;0;1920;1019;1151.103;-3287.854;3.227385;True;True
...
Node;AmplifyShaderEditor.Vector2Node;251;-2121.855,5002.319;Inherit;False;Property;_SubSpell2_Position;SubSpell2_Position;27;0;Create;True;0;0;0;False;0;False;0,0;0.00305363,0.01025453;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;224;-2083.032,4114.107;Inherit;False;Property;_SubSpell1_Position;SubSpell1_Position;26;0;Create;True;0;0;0;False;0;False;0,0;-0.0009358142,-0.001952303;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;287;-1082.851,6350.335;Inherit;False;Step Antialiasing;-1;;212;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;298;-1051.297,7147.077;Inherit;False;Step Antialiasing;-1;;219;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;258;-1092.596,5132.617;Inherit;False;Step Antialiasing;-1;;217;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;250;-1115.176,4587.395;Inherit;False;Step Antialiasing;-1;;223;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;297;-1052.614,7032.588;Inherit;False;Step Antialiasing;-1;;221;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;247;-1103.333,4286.036;Inherit;False;Step Antialiasing;-1;;214;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;299;-1068.404,7233.933;Inherit;False;Step Antialiasing;-1;;225;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;285;-1067.061,6148.99;Inherit;False;Step Antialiasing;-1;;227;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;286;-1065.744,6263.479;Inherit;False;Step Antialiasing;-1;;215;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;249;-1098.069,4500.538;Inherit;False;Step Antialiasing;-1;;228;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;288;-1071.008,6048.977;Inherit;False;Step Antialiasing;-1;;216;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;248;-1099.386,4386.049;Inherit;False;Step Antialiasing;-1;;218;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;197;-1284.141,2976.423;Inherit;False;Step Antialiasing;-1;;224;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;354;891.524,4250.337;Inherit;False;Property;_SubSpell3Intensity;SubSpell3Intensity;34;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;195;-1281.105,2794.247;Inherit;False;Step Antialiasing;-1;;229;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;187;-689.6956,2119.449;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.501;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;198;-1286.165,3063.461;Inherit;False;Step Antialiasing;-1;;222;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;196;-1282.117,2884.321;Inherit;False;Step Antialiasing;-1;;230;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;137;-706.2865,1686.93;Inherit;False;Step Antialiasing;-1;;231;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;133;-709.2679,1216.037;Inherit;False;Step Antialiasing;-1;;234;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;132;-708.2679,1125.036;Inherit;False;Step Antialiasing;-1;;232;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;138;-707.7655,1777.14;Inherit;False;Step Antialiasing;-1;;233;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;82;-1716.806,-170.5175;Inherit;False;Step Antialiasing;-1;;235;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.425;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;67;-1752.708,683.427;Inherit;False;Step Antialiasing;-1;;236;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;154;-1860.489,33.15498;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;28;-1754.052,-300.684;Inherit;False;Step Antialiasing;-1;;237;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;150;-1719.776,31.7309;Inherit;False;Step Antialiasing;-1;;239;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;149;-1718.776,-56.26912;Inherit;False;Step Antialiasing;-1;;238;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=4EEFBDCAFF08060E416EAEE077AF53302D88C233