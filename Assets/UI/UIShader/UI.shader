...
Shader "UI"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_3_0_g125 = ( 1.0 - uv_TexCoord70.x );
			float temp_output_3_0_g118 = ( 1.0 - ( 1.0 - uv_TexCoord70.y ) );
			float4 tex2DNode68 = tex2D( _Empty_LifeBar, uv_TexCoord70 );
			float temp_output_3_0_g64 = ( (0.06 + (_Life - 0.0) * (0.83 - 0.06) / (1.0 - 0.0)) - uv_TexCoord70.x );
			...
			float temp_output_83_0 = ( saturate( ( temp_output_3_0_g64 / fwidth( temp_output_3_0_g64 ) ) ) * ( 1.0 - temp_output_82_0 ) * tex2DNode69.a );
			float temp_output_3_0_g68 = ( (0.1 + (_Stamina - 0.0) * (0.63 - 0.1) / (1.0 - 0.0)) - uv_TexCoord70.x );
			float temp_output_85_0 = ( temp_output_82_0 * tex2DNode69.a * saturate( ( temp_output_3_0_g68 / fwidth( temp_output_3_0_g68 ) ) ) );
			float4 lerpResult99 = lerp( ( saturate( ( temp_output_3_0_g125 / fwidth( temp_output_3_0_g125 ) ) ) * saturate( ( temp_output_3_0_g118 / fwidth( temp_output_3_0_g118 ) ) ) * tex2DNode68 ) , ( ( _LifeColor * temp_output_83_0 ) + ( temp_output_85_0 * _StaminaColor ) ) , ( temp_output_83_0 + temp_output_85_0 ));
			...
			float temp_output_3_0_g67 = ( 1.0 - uv_TexCoord106.x );
			float temp_output_132_0 = saturate( ( temp_output_3_0_g67 / fwidth( temp_output_3_0_g67 ) ) );
			float temp_output_3_0_g66 = ( 1.0 - uv_TexCoord106.y );
			float temp_output_133_0 = saturate( ( temp_output_3_0_g66 / fwidth( temp_output_3_0_g66 ) ) );
			...
			float temp_output_3_0_g63 = ( 1.0 - ( 1.0 - uv_TexCoord112.x ) );
			float temp_output_137_0 = saturate( ( temp_output_3_0_g63 / fwidth( temp_output_3_0_g63 ) ) );
			float temp_output_3_0_g65 = ( 1.0 - uv_TexCoord112.y );
			float temp_output_138_0 = saturate( ( temp_output_3_0_g65 / fwidth( temp_output_3_0_g65 ) ) );
			...
			float temp_output_3_0_g14 = ( 1.0 - uv_TexCoord163.x );
			float temp_output_3_0_g13 = ( 1.0 - ( 1.0 - uv_TexCoord163.x ) );
			float temp_output_3_0_g12 = ( 1.0 - uv_TexCoord163.y );
			float temp_output_3_0_g11 = ( 1.0 - ( 1.0 - uv_TexCoord163.y ) );
			float temp_output_199_0 = ( saturate( ( temp_output_3_0_g14 / fwidth( temp_output_3_0_g14 ) ) ) * saturate( ( temp_output_3_0_g13 / fwidth( temp_output_3_0_g13 ) ) ) * saturate( ( temp_output_3_0_g12 / fwidth( temp_output_3_0_g12 ) ) ) * saturate( ( temp_output_3_0_g11 / fwidth( temp_output_3_0_g11 ) ) ) );
			...
			float temp_output_3_0_g92 = ( 1.0 - uv_TexCoord215.x );
			float temp_output_3_0_g111 = ( 1.0 - ( 1.0 - uv_TexCoord215.x ) );
			float temp_output_3_0_g108 = ( 1.0 - uv_TexCoord215.y );
			float temp_output_3_0_g110 = ( 1.0 - ( 1.0 - uv_TexCoord215.y ) );
			float temp_output_243_0 = ( saturate( ( temp_output_3_0_g92 / fwidth( temp_output_3_0_g92 ) ) ) * saturate( ( temp_output_3_0_g111 / fwidth( temp_output_3_0_g111 ) ) ) * saturate( ( temp_output_3_0_g108 / fwidth( temp_output_3_0_g108 ) ) ) * saturate( ( temp_output_3_0_g110 / fwidth( temp_output_3_0_g110 ) ) ) );
			...
			float temp_output_3_0_g112 = ( 1.0 - uv_TexCoord252.x );
			float temp_output_3_0_g122 = ( 1.0 - ( 1.0 - uv_TexCoord252.x ) );
			float temp_output_3_0_g90 = ( 1.0 - uv_TexCoord252.y );
			float temp_output_3_0_g91 = ( 1.0 - ( 1.0 - uv_TexCoord252.y ) );
			float temp_output_259_0 = ( saturate( ( temp_output_3_0_g112 / fwidth( temp_output_3_0_g112 ) ) ) * saturate( ( temp_output_3_0_g122 / fwidth( temp_output_3_0_g122 ) ) ) * saturate( ( temp_output_3_0_g90 / fwidth( temp_output_3_0_g90 ) ) ) * saturate( ( temp_output_3_0_g91 / fwidth( temp_output_3_0_g91 ) ) ) );
			...
			float temp_output_3_0_g114 = ( 1.0 - uv_TexCoord268.x );
			float temp_output_3_0_g107 = ( 1.0 - ( 1.0 - uv_TexCoord268.x ) );
			float temp_output_3_0_g121 = ( 1.0 - uv_TexCoord268.y );
			float temp_output_3_0_g117 = ( 1.0 - ( 1.0 - uv_TexCoord268.y ) );
			float temp_output_276_0 = ( saturate( ( temp_output_3_0_g114 / fwidth( temp_output_3_0_g114 ) ) ) * saturate( ( temp_output_3_0_g107 / fwidth( temp_output_3_0_g107 ) ) ) * saturate( ( temp_output_3_0_g121 / fwidth( temp_output_3_0_g121 ) ) ) * saturate( ( temp_output_3_0_g117 / fwidth( temp_output_3_0_g117 ) ) ) );
			...
			float temp_output_3_0_g106 = ( 1.0 - uv_TexCoord282.x );
			float temp_output_3_0_g104 = ( 1.0 - ( 1.0 - uv_TexCoord282.x ) );
			float temp_output_3_0_g105 = ( 1.0 - uv_TexCoord282.y );
			float temp_output_3_0_g113 = ( 1.0 - ( 1.0 - uv_TexCoord282.y ) );
			float temp_output_289_0 = ( saturate( ( temp_output_3_0_g106 / fwidth( temp_output_3_0_g106 ) ) ) * saturate( ( temp_output_3_0_g104 / fwidth( temp_output_3_0_g104 ) ) ) * saturate( ( temp_output_3_0_g105 / fwidth( temp_output_3_0_g105 ) ) ) * saturate( ( temp_output_3_0_g113 / fwidth( temp_output_3_0_g113 ) ) ) );
			...
			float temp_output_3_0_g119 = ( 1.0 - uv_TexCoord294.x );
			float temp_output_3_0_g109 = ( 1.0 - ( 1.0 - uv_TexCoord294.x ) );
			float temp_output_3_0_g120 = ( 1.0 - uv_TexCoord294.y );
			float temp_output_3_0_g123 = ( 1.0 - ( 1.0 - uv_TexCoord294.y ) );
			float temp_output_301_0 = ( saturate( ( temp_output_3_0_g119 / fwidth( temp_output_3_0_g119 ) ) ) * saturate( ( temp_output_3_0_g109 / fwidth( temp_output_3_0_g109 ) ) ) * saturate( ( temp_output_3_0_g120 / fwidth( temp_output_3_0_g120 ) ) ) * saturate( ( temp_output_3_0_g123 / fwidth( temp_output_3_0_g123 ) ) ) );
			...
			float temp_output_3_0_g124 = ( 1.0 - uv_TexCoord306.x );
			float temp_output_3_0_g115 = ( 1.0 - ( 1.0 - uv_TexCoord306.x ) );
			float temp_output_3_0_g103 = ( 1.0 - uv_TexCoord306.y );
			float temp_output_3_0_g116 = ( 1.0 - ( 1.0 - uv_TexCoord306.y ) );
			float temp_output_313_0 = ( saturate( ( temp_output_3_0_g124 / fwidth( temp_output_3_0_g124 ) ) ) * saturate( ( temp_output_3_0_g115 / fwidth( temp_output_3_0_g115 ) ) ) * saturate( ( temp_output_3_0_g103 / fwidth( temp_output_3_0_g103 ) ) ) * saturate( ( temp_output_3_0_g116 / fwidth( temp_output_3_0_g116 ) ) ) );
...
/*ASEBEGIN
Version=19001
-1920;0;1920;1059;8736.248;763.6787;9.318105;True;False
...
Node;AmplifyShaderEditor.Vector2Node;251;-2121.855,5002.319;Inherit;False;Property;_SubSpell2_Position;SubSpell2_Position;27;0;Create;True;0;0;0;False;0;False;0,0;-1.18,-1.28;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;224;-2083.032,4114.107;Inherit;False;Property;_SubSpell1_Position;SubSpell1_Position;26;0;Create;True;0;0;0;False;0;False;0,0;-0.14,-1.63;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;293;-2155.535,7510.155;Inherit;False;Property;_SubSpell5_Position;SubSpell5_Position;30;0;Create;True;0;0;0;False;0;False;0,0;-7.928,-1.63;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;305;-2136.45,8307.85;Inherit;False;Property;_SubSpell6_Position;SubSpell6_Position;31;0;Create;True;0;0;0;False;0;False;0,0;-1.81,-0.41;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;267;-2151.177,5850.552;Inherit;False;Property;_SubSpell3_Position;SubSpell3_Position;28;0;Create;True;0;0;0;False;0;False;0,0;-6.255,-0.41;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.WireNode;236;-2304.986,4065.366;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;281;-2186.069,6739.178;Inherit;False;Property;_SubSpell4_Position;SubSpell4_Position;29;0;Create;True;0;0;0;False;0;False;0,0;-6.885,-1.28;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;248;-1099.386,4386.049;Inherit;False;Step Antialiasing;-1;;111;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;250;-1115.176,4587.395;Inherit;False;Step Antialiasing;-1;;110;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;274;-1116.656,6195.352;Inherit;False;Step Antialiasing;-1;;121;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;255;-1088.649,5232.63;Inherit;False;Step Antialiasing;-1;;122;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;249;-1098.069,4500.538;Inherit;False;Step Antialiasing;-1;;108;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;287;-1168.654,7170.834;Inherit;False;Step Antialiasing;-1;;113;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;299;-1138.119,7941.811;Inherit;False;Step Antialiasing;-1;;123;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;298;-1121.012,7854.955;Inherit;False;Step Antialiasing;-1;;120;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;312;-1107.193,8438.148;Inherit;False;Step Antialiasing;-1;;124;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;194;-1456.197,3038.164;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;272;-1133.763,6282.208;Inherit;False;Step Antialiasing;-1;;117;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;271;-1121.92,5980.85;Inherit;False;Step Antialiasing;-1;;114;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;297;-1122.329,7740.466;Inherit;False;Step Antialiasing;-1;;109;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;257;-1087.332,5347.119;Inherit;False;Step Antialiasing;-1;;90;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;288;-1156.811,6869.476;Inherit;False;Step Antialiasing;-1;;106;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;286;-1151.547,7083.978;Inherit;False;Step Antialiasing;-1;;105;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;185;-904.1674,2124.81;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;310;-1101.929,8652.651;Inherit;False;Step Antialiasing;-1;;103;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;247;-1103.333,4286.036;Inherit;False;Step Antialiasing;-1;;92;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;300;-1126.276,7640.453;Inherit;False;Step Antialiasing;-1;;119;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;273;-1117.973,6080.863;Inherit;False;Step Antialiasing;-1;;107;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;285;-1152.864,6969.489;Inherit;False;Step Antialiasing;-1;;104;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;258;-1092.596,5132.617;Inherit;False;Step Antialiasing;-1;;112;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;309;-1103.246,8538.161;Inherit;False;Step Antialiasing;-1;;115;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;311;-1119.036,8739.506;Inherit;False;Step Antialiasing;-1;;116;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;256;-1104.439,5433.975;Inherit;False;Step Antialiasing;-1;;91;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;197;-1284.141,2976.423;Inherit;False;Step Antialiasing;-1;;12;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;196;-1282.117,2884.321;Inherit;False;Step Antialiasing;-1;;13;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;198;-1286.165,3063.461;Inherit;False;Step Antialiasing;-1;;11;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;139;-945.0717,1684.164;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;195;-1281.105,2794.247;Inherit;False;Step Antialiasing;-1;;14;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;82;-1716.806,-170.5175;Inherit;False;Step Antialiasing;-1;;31;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.425;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;67;-1752.708,683.427;Inherit;False;Step Antialiasing;-1;;68;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;28;-1754.052,-300.684;Inherit;False;Step Antialiasing;-1;;64;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;137;-706.2865,1686.93;Inherit;False;Step Antialiasing;-1;;63;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;132;-708.2679,1125.036;Inherit;False;Step Antialiasing;-1;;67;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;154;-1860.489,33.15498;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;133;-709.2679,1216.037;Inherit;False;Step Antialiasing;-1;;66;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;138;-707.7655,1777.14;Inherit;False;Step Antialiasing;-1;;65;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;149;-1718.776,-56.26912;Inherit;False;Step Antialiasing;-1;;125;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;150;-1719.776,31.7309;Inherit;False;Step Antialiasing;-1;;118;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=7955E380E6357E229577B6622E1F7FBA4B0CFBB4