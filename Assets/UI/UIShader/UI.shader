...
Shader "UI"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_3_0_g37 = ( 1.0 - ( 1.0 - uv_TexCoord70.y ) );
			...
			float temp_output_3_0_g34 = ( (0.1 + (_Stamina - 0.0) * (0.63 - 0.1) / (1.0 - 0.0)) - uv_TexCoord70.x );
			float temp_output_85_0 = ( temp_output_82_0 * tex2DNode69.a * saturate( ( temp_output_3_0_g34 / fwidth( temp_output_3_0_g34 ) ) ) );
			float4 lerpResult99 = lerp( ( saturate( ( temp_output_3_0_g38 / fwidth( temp_output_3_0_g38 ) ) ) * saturate( ( temp_output_3_0_g37 / fwidth( temp_output_3_0_g37 ) ) ) * tex2DNode68 ) , ( ( _LifeColor * temp_output_83_0 ) + ( temp_output_85_0 * _StaminaColor ) ) , ( temp_output_83_0 + temp_output_85_0 ));
			float2 appendResult113 = (float2(_SpellScaleX , _SpellScaleY));
			float2 uv_TexCoord106 = i.uv_texcoord * appendResult113;
			float temp_output_3_0_g43 = ( 1.0 - uv_TexCoord106.x );
			float temp_output_132_0 = saturate( ( temp_output_3_0_g43 / fwidth( temp_output_3_0_g43 ) ) );
			...
			float temp_output_3_0_g42 = ( 1.0 - ( 1.0 - uv_TexCoord112.x ) );
			float temp_output_137_0 = saturate( ( temp_output_3_0_g42 / fwidth( temp_output_3_0_g42 ) ) );
			float temp_output_3_0_g41 = ( 1.0 - uv_TexCoord112.y );
			float temp_output_138_0 = saturate( ( temp_output_3_0_g41 / fwidth( temp_output_3_0_g41 ) ) );
...
/*ASEBEGIN
Version=19001
-1920;0;1920;1059;3646.17;-424.9101;2.735473;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;146;-2711.886,1075.036;Inherit;False;3057.153;839.746;Spells;21;108;115;131;130;113;118;112;106;139;137;103;138;133;104;132;143;136;134;144;125;123;Spells;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-2331.489,-280.469;Inherit;False;Property;_Life;Life;2;0;Create;True;0;0;0;False;0;False;0.4999876;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;67;-1767.125,726.6765;Inherit;False;Step Antialiasing;-1;;34;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;150;-1734.192,74.98042;Inherit;False;Step Antialiasing;-1;;37;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;138;-707.7655,1777.14;Inherit;False;Step Antialiasing;-1;;41;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;132;-708.2679,1125.036;Inherit;False;Step Antialiasing;-1;;43;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;137;-706.2865,1686.93;Inherit;False;Step Antialiasing;-1;;42;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=2FAF12AACCEF0F6BD8E054DED6338ED10E41EBB8