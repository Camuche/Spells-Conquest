...
Shader "Racine"
{
	Properties
	{
		...
		_Grow("Grow", Range( 0 , 1)) = 0.4727595
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_118_0 = ( _Grow * 2.0 );
			float3 ase_vertexNormal = v.normal.xyz;
			v.vertex.xyz += ( ( saturate( ( (0.0 + (temp_output_118_0 - 0.0) * (1.3 - 0.0) / (1.0 - 0.0)) - v.texcoord.xy.y ) ) * ase_vertexNormal ) * _PushPull );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode119 = tex2D( _Metallic, uv_Metallic );
			o.Metallic = tex2DNode119.r;
			o.Smoothness = tex2DNode119.a;
			float2 uv_Texture_AO = i.uv_texcoord * _Texture_AO_ST.xy + _Texture_AO_ST.zw;
			o.Occlusion = tex2D( _Texture_AO, uv_Texture_AO ).r;
			o.Alpha = 1;
			float temp_output_118_0 = ( _Grow * 2.0 );
			clip( ( 1.0 - saturate( ( ( _MultiplyOpacity * ( _AddOpacity + temp_output_118_0 ) ) - i.uv_texcoord.y ) ) ) - _Cutoff );
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1140.289,-965.1838;Inherit;False;Property;_Dissolve_Scale;Dissolve_Scale;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-1262.303,-774.7026;Inherit;False;Property;_Dissolve;Dissolve;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-650.758,652.2295;Inherit;False;Property;_PushPull;PushPull;4;0;Create;True;0;0;0;False;0;False;-0.1;-0.015;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-1772.465,264.4427;Inherit;False;Property;_AddOpacity;AddOpacity;5;0;Create;True;0;0;0;False;0;False;0;0.91;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;110;-1609.115,191.4614;Inherit;False;Property;_MultiplyOpacity;MultiplyOpacity;6;0;Create;True;0;0;0;False;0;False;1;0.57;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;43;-1622.951,380.5366;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;118;-1984,544;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-2272,544;Inherit;False;Property;_Grow;Grow;3;0;Create;True;0;0;0;False;0;False;0.4727595;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;113;-688,-336;Inherit;True;Property;_Texture_Normal;Texture_Normal;8;0;Create;True;0;0;0;False;0;False;-1;None;8d5ba59712dd64c43b521ee2028f3434;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;112;-688,-528;Inherit;True;Property;_Texture_Albedo;Texture_Albedo;7;0;Create;True;0;0;0;False;0;False;-1;None;8554150fa0e48cb48b6048a6d8e3a6f7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;114;-688,-144;Inherit;True;Property;_Texture_AO;Texture_AO;9;0;Create;True;0;0;0;False;0;False;-1;None;2bb697eaa62e93141ac9ce92be364655;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;119;-688,48;Inherit;True;Property;_Metallic;Metallic;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
WireConnection;0;0;112;0
WireConnection;0;1;113;0
WireConnection;0;3;119;1
WireConnection;0;4;119;4
...
ASEEND*/
//CHKSM=2C87F9A45C688B4700300DA0397BBB97E160D2A3