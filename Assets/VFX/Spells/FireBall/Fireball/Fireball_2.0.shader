...
Shader "Fireball_2.0"
{
	Properties
	{
		...
		[HDR]_Color1("Color 1", Color) = (1,0.6666667,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float clampResult110 = clamp( (0.0 + (voroi43 - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) , 0.0 , 1.0 );
			float4 lerpResult46 = lerp( _Color0 , _Color1 , clampResult110);
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 ase_worldNormal = i.worldNormal;
			float fresnelNdotV1 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode1 = ( 0.0 + _Fresnel_Scale * pow( 1.0 - fresnelNdotV1, _Fresnel_Power ) );
			float clampResult111 = clamp( fresnelNode1 , 0.0 , 1.0 );
			float4 lerpResult2 = lerp( lerpResult46 , _Color1 , clampResult111);
			float fresnelNdotV52 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode52 = ( 0.0 + 5.5 * pow( 1.0 - fresnelNdotV52, _Float3 ) );
			float clampResult57 = clamp( ( 1.0 - fresnelNode52 ) , 0.0 , 1.0 );
			float4 lerpResult54 = lerp( lerpResult2 , _Color2 , clampResult57);
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-6.339434,360.3115;Inherit;False;Property;_Tess;Tess;7;0;Create;True;0;0;0;False;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-704.0779,632.6927;Inherit;False;Property;_VertexOffset_Intensity;VertexOffset_Intensity;4;0;Create;True;0;0;0;False;0;False;0;0.05;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1016.274,826.4246;Inherit;False;Property;_NoiseScale;NoiseScale;5;0;Create;True;0;0;0;False;0;False;13.25;14.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-2704.767,465.3484;Inherit;False;Property;_Time_Speed;Time_Speed;6;0;Create;True;0;0;0;False;0;False;0;0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1203.118,380.8742;Inherit;False;Property;_Fresnel_Scale;Fresnel_Scale;0;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-1204.818,452.8741;Inherit;False;Property;_Fresnel_Power;Fresnel_Power;3;0;Create;True;0;0;0;False;0;False;5;18.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-887.929,1153.224;Inherit;False;Property;_SmoothStep;SmoothStep;8;0;Create;True;0;0;0;False;0;False;0.29;0.29;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-570.4646,1551.256;Inherit;False;Property;_WaveIntensity;WaveIntensity;11;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-834.0547,1702.848;Inherit;False;Property;_SmoothStepWave;SmoothStepWave;9;0;Create;True;0;0;0;False;0;False;0.29;0.74;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-1885.822,200.8656;Inherit;False;Property;_VoronoisScale;VoronoisScale;10;0;Create;True;0;0;0;False;0;False;10;7.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;70.02051,-64.75934;Inherit;False;Property;_Float0;Float 0;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;104;70.02051,-135.7593;Inherit;False;Property;_Float1;Float 1;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-1547.999,-214.155;Inherit;False;Property;_hdr;hdr;14;0;Create;True;0;0;0;False;0;False;0;12.09;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;110;-1181.603,122.5618;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;111;-646.0566,348.6449;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OutlineNode;112;-608.8281,-435.2152;Inherit;False;0;True;None;0;0;Front;True;True;True;True;0;False;;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;4;-1714.457,-432.9302;Inherit;False;Property;_Color1;Color 1;1;1;[HDR];Create;True;0;0;0;False;0;False;1,0.6666667,0,0;0.7490196,0.5019608,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;3;-1691.558,-624.7281;Inherit;False;Property;_Color0;Color 0;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,0,0;8.47419,8.47419,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;113;-961.0028,-230.5949;Inherit;False;Property;_Float3;Float 3;15;0;Create;True;0;0;0;False;0;False;0;1.64;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;114;-261.2155,209.3301;Inherit;False;Property;_Color2;Color 2;16;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;5.992157,5.992157,5.992157,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;52;-670.3651,-311.1545;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;5.5;False;3;FLOAT;1.64;False;1;FLOAT;0
WireConnection;54;0;2;0
WireConnection;54;1;114;0
...
WireConnection;52;3;113;0
ASEEND*/
//CHKSM=2252C243BE2227A578958CFADC905D9F897CC601