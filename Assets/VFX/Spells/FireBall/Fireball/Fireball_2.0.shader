...
Shader "Fireball_2.0"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult46 = lerp( ( _Color0 * _hdr ) , color4 , clampResult110);
			...
			float4 lerpResult2 = lerp( lerpResult46 , color4 , clampResult111);
			float4 temp_cast_0 = (1.0).xxxx;
			float fresnelNdotV52 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode52 = ( 0.0 + 5.5 * pow( 1.0 - fresnelNdotV52, 1.64 ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1204.818,452.8741;Inherit;False;Property;_Fresnel_Power;Fresnel_Power;2;0;Create;True;0;0;0;False;0;False;5;16.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-1547.999,-214.155;Inherit;False;Property;_hdr;hdr;13;0;Create;True;0;0;0;False;0;False;0;1.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;4;-1714.457,-432.9302;Inherit;False;Constant;_Color1;Color 1;0;0;Create;True;0;0;0;False;0;False;1,0.6666667,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;107;-1364.834,-89.4258;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=BDC9E809319EEFFF6D8B9379A656C1B78207D96B