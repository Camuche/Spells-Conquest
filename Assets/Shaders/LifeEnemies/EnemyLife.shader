...
Shader "EnemyLife"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode2 = tex2D( _UI_MasqueVieEnnemis, uv_UI_MasqueVieEnnemis );
			float temp_output_8_0 = step( i.uv_texcoord.x , _Life );
			float4 lerpResult14 = lerp( float4( 1,1,1,0 ) , ( color12 * tex2DNode2.a * temp_output_8_0 ) , tex2DNode2.a);
			...
			clip( ( tex2D( _UI_BarreDeVieEnnemis, uv_UI_BarreDeVieEnnemis ).a + ( tex2DNode2.a * temp_output_8_0 ) ) - _Cutoff );
		}
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-640,368;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-640,-128;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;8;-832,-80;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-928,-272;Inherit;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;5;-1152,-176;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-1328,80;Inherit;True;Property;_UI_BarreDeVieEnnemis;UI_BarreDeVieEnnemis;1;0;Create;True;0;0;0;False;0;False;-1;468d88525758b684cb2be868c1c44f9f;468d88525758b684cb2be868c1c44f9f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-1216,-48;Inherit;False;Property;_Life;Life;3;0;Create;True;0;0;0;False;0;False;0.5760869;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=04AE417893F0E7F62C4CB5092A823C65B03EDA8F