	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 appendResult23_g10 = (float2(( length( CenteredUV15_g10 ) * (20.0 + (_Fade_From_Center_Value - 0.0) * (0.0 - 20.0) / (1.0 - 0.0)) * 2.0 ) , ( atan2( break17_g10.x , break17_g10.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
