...
Shader "Custom/Lave"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_72_0 = ( ( -1.0 * ( _SpherePosition.x + -0.5 ) ) + ase_worldPos.x );
			...
			float2 CenteredUV15_g3 = ( appendResult59 - float2( 0.5,0.5 ) );
			...
			float temp_output_74_0 = ( ( -1.0 * ( _SpherePosition.z + -0.5 ) ) + ase_worldPos.z );
			...
			float2 CenteredUV15_g4 = ( appendResult62 - float2( 0.5,0.5 ) );
			float2 break17_g4 = CenteredUV15_g4;
			float2 appendResult23_g4 = (float2(( length( CenteredUV15_g4 ) * 1.0 * 2.0 ) , ( atan2( break17_g4.x , break17_g4.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float temp_output_67_0 = ( (appendResult23_g3).x * (appendResult23_g2).x * (appendResult23_g4).x );
...
/*ASEBEGIN
Version=19001
0;0;1920;1019;579.7489;1738.284;1;True;True
Node;AmplifyShaderEditor.Vector3Node;71;-305.6469,-1377.705;Inherit;False;Property;_SpherePosition;Sphere Position;14;0;Create;True;0;0;0;False;0;False;0,0,0;-0.4,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;90;-108.7489,-1208.284;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;89;1.251099,-1461.284;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;58;739.6791,-1198.711;Inherit;False;Polar Coordinates;-1;;3;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;64;735.3518,-832.3185;Inherit;False;Polar Coordinates;-1;;4;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;1556.617,-820.1331;Inherit;False;Property;_Size;Size;13;0;Create;True;0;0;0;False;0;False;0;81.82;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;84;1964.171,-1519.898;Inherit;True;Polar Coordinates;-1;;6;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;80;1949.526,-1763.584;Inherit;True;Polar Coordinates;-1;;7;7dab8e02884cf104ebefaa2e788e4162;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0.5,0.5;False;3;FLOAT;1;False;4;FLOAT;1;False;1;FLOAT2;0
...
WireConnection;90;0;71;3
WireConnection;89;0;71;1
...
ASEEND*/
//CHKSM=1AF94CEF969D93046F63DF9E2A9EA1F4C83FFA8B